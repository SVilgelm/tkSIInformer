...
class TestModels(unittest.TestCase):
    ...
    def test_author(self):
        author = models.Author(name="Ясинский Анджей",
    ...
    def test_book(self):
        author = models.Author(name="Ясинский Анджей",
                               url="http://samlib.ru/p/pupkin_wasja_ibragimowich/indexdate.shtml").save()
        ...
        book = models.Book(
            ...
            list="Глава",
            desk="Прода к шестой книге от 09.08.2012. Глава 6. Приятного чтения. Спасибо всем, кто приложил руки к вычитке предыдущих глав. Здесь можно править текущий текст: Прода для редактирования",
        ).save()
        self.assertTrue(book.is_new)

        book = models.Book(
            author_id=author.id,
            url='http://samlib.ru/p/pupkin_wasja_ibragimowich/updatetxt2.shtml',
            name="Ник. Последнее обновление",
            list="Глава",
            desk="Прода к шестой книге от 09.08.2012. Глава 6. Приятного чтения. Спасибо всем, кто приложил руки к вычитке предыдущих глав. Здесь можно править текущий текст: Прода для редактирования",
        ).save()
